defmodule ElixirBoilerplateWeb.Errors.Helpers do
  ...
  @doc """
  Generates a human-readable block containing all errors in a changeset
  """
  ...
  defp convert_error_field({field, errors}, memo, schema) when is_list(errors), do: memo ++ Enum.flat_map(errors, &convert_error_subfield(&1, field, memo, schema))
